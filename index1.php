          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <ul class="contact-details">
                ...
                <li><a href="#"><i class="fa fa-phone"></i> +9471 7 98 98 98</a>
                </li>
              </ul>
              <!-- End Contact Info -->
            </div>
      ...
      <div id="main-slide" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <div class="item">
            ...
            <div class="slider-content">
              <div class="col-md-12 text-center">
                <h3 style="padding-bottom : 30px;" class="animated3 white">
                <span><strong>Hello</strong> <?php echo $_SESSION["sess_user"] ;?>!</span>
                </h3>
                <h2 class="animated2 white">
                  <span>Welcome to <strong>SLCABS</strong></span>
              </h2>
        ...
        <div class="row footer-widgets">
          ...
          <div class="col-md-3">
            <div class="footer-widget contact-widget">
              ...
              <ul>
                <li><span>Phone Number:</span> +9471 7 98 98 98</li>
